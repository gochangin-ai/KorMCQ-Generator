...
llm =ChatOpenAI(model_name="gpt-3.5-turbo", temperature=0)
template = """You are an human resources expert and writer. Given a multiple choice quiz for {grade} grade students.\
...
with st.form("user_inputs"):
    ...
    # Input fields
    mcq_count = st.number_input("객관식 문제 수", min_value=3, max_value=20)
